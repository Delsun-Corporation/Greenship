        ...
        <FormLayout
            leftComponent={
                <Stack direction="column" spacing={2}>
                    <Box sx={{ fontSize: 24, fontWeight: "bold" }}>Outdoor Air Introduction</Box>
                    <ToggleInput control={control} name={`${sectionName}.d_a_is_potential`} title="Is there any outdoor air introduction potentials?" />
...
const AchSection = ({ control, getValues, setValue }) => {
    ...
    return (
        <FormLayout
            leftComponent={
                <Stack direction="column" spacing={2}>
                    <Box sx={{ fontSize: 24, fontWeight: "bold" }}>Air Changes per Hour (ACH)</Box>
            ...
            rightComponent={
                <Stack direction="column" spacing={2}>
                    <Box sx={{ fontWeight: "bold" }}>Graph: Calculated ACH vs. Standard ACH</Box>
                    <AchGraph />
                </Stack>
            }
        />
...
const AccessOutsideSection = ({ control, getValues, setValue }) => {
    ...
    return (
        <FormLayout
            leftComponent={
                <Stack direction="column" spacing={2}>
                    <Box sx={{ fontSize: 24, fontWeight: "bold" }}>Access to Outside View</Box>
            ...
            rightComponent={
                <Stack direction="column" spacing={2}>
                    <Box sx={{ fontWeight: "bold" }}>Graph: Calculated Area with access to outside view vs. Greenship standard</Box>
                    <AccessOutsideGraph />
                </Stack>
            }
        />
    ...
    const IlluminanceGraph = () => {
        ...
        resultArr.calculatedE.map(function (value, index) {
            ...
            if (chartData.length <= index) {
                chartData.push({ label: watchValues[index].room_activity.locActivity, value: value, standard: watchValues[index].room_activity.e })
            } else {
                chartData[index] = { label: watchValues[index].room_activity.locActivity, value: value, standard: watchValues[index].room_activity.e }
            }
        })
            ...
            return (
                <ResponsiveContainer width="99%" height={200 + (chartData.length * 60)}>
                    ...
                    >
                        ...
                        <XAxis type="number" dataKey="value" />
                        <Tooltip />
                        <Legend height={10} wrapperStyle={{ position: 'relative', marginTop: '0px' }} />
                                ...
                                <Accordion key={field.id}>
                                    ...
                                    <AccordionDetails>
                                        <Stack spacing={2}>
                                            ...
                                            <Divider style={{ width: "100%" }} />
                                            <Box sx={{ fontSize: 14, fontWeight: "bold", color: "text.secondary" }}>LIGHTING PLAN</Box>
                                            <BlockInput
...
const ThermalComfortSection = ({ control, getValues, setValue }) => {
    ...
    return (
        <FormLayout
            ...
            rightComponent={
                <Stack direction="column" spacing={2}>
                    <Box sx={{ fontWeight: "bold" }}>Graph: Planned temperature setting vs. Greenship standard</Box>
                    <AcTempGraph />
                </Stack>
            }
        />
...
const AcousticalComfortSection = ({ control, getValues, setValue }) => {
            ...
            <Box>
                <ResponsiveContainer width="90%" height={200}>
                    ...
                    >
                        ...
                        <Bar name="Baseline standard" dataKey="min" stackId="a" fill={barColors[1]} />
                        <Bar name="Allowed standard" dataKey="max" stackId="a" fill="#82ca9d" />
                    </BarChart>
                </ResponsiveContainer>
            </Box>
    ...
    return (
        <FormLayout
            ...
            rightComponent={
                <Stack direction="column" spacing={2}>
                    <Box sx={{ fontWeight: "bold" }}>Graph: Noise level in site vs. Standard allowed noise</Box>
                    <NoiseGraph />
                </Stack>
            }
        />
