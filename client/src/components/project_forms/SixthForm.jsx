...
const NetZeroSection = ({ getValues }) => {
    ...
    const ConsumptionEnergyIndexGraph = () => {
        const totalDec = dec.lighting + dec.ac + dec.appliances + dec.utility + dec.plug

        const baselineEnergyConsumption = parseInt(getValues(`firstForm.a_typology_eci`))

        const chartData = [
            { label: "Building Design Energy Consumption", value: totalDec },
            { label: "Baseline Energy Consumption Index", value: baselineEnergyConsumption }
        ]
            ...
            <Box>
                <ResponsiveContainer width="99%" height={300}>
                    ...
                    >
                        ...
                        <XAxis type="number" dataKey="value" domain={[0, 'dataMax']} tickFormatter={tick => `${tick}°C`} />
    ...
    return (
        <Container maxWidth="xl" disableGutters>
            <Paper elevation={2} >
                <Box width="100%" sx={{ backgroundColor: "#c09577", color: "white", borderRadius: 1, paddingX: 4, paddingY: 2 }}>
                    <Box sx={{ fontSize: 24, fontWeight: "bold" }}>Towards Net Zero Building</Box>
                </Box>
                ...
                <Stack direction="column" spacing={2} sx={{ padding: 4 }}>
                    ...
                    >
                        <Stack direction="column" spacing={2} width="50%" >
                            <Box sx={{ fontSize: 20, fontWeight: "bold" }}>Consumption Energy Index</Box>
                            <ConsumptionEnergyIndexGraph />
                        </Stack>
                        <Stack direction="column" spacing={2} >
                            <Box sx={{ fontSize: 20, fontWeight: "bold" }}>Consumption Energy Percentages</Box>
...
const HealthyBuildingSection = ({ getValues }) => {
    ...
    return (
        <Container maxWidth="xl" disableGutters>
            <Paper elevation={2} >
                <Box width="100%" sx={{ backgroundColor: "#c09577", color: "white", borderRadius: 1, paddingX: 4, paddingY: 2 }}>
                    <Box sx={{ fontSize: 24, fontWeight: "bold" }}>Towards Healthy Building</Box>
                </Box>

                <Stack direction="column" spacing={2} sx={{ padding: 4 }}>
                    <Box sx={{ fontSize: 20, fontWeight: "bold" }}>Breathing Zone Outdoor Airflow (VBz)</Box>
                    <VbzGraph />
                    <Divider style={{ width: "100%" }} />
                    <Box sx={{ fontSize: 20, fontWeight: "bold" }}>Air Change per Hour (ACH)</Box>
                    <AchGraph />
                    <Divider style={{ width: "100%" }} />
                    <Box sx={{ fontSize: 20, fontWeight: "bold" }}>Access to Outside View</Box>
                    <AccessOutsideGraph />
                    <Divider style={{ width: "100%" }} />
                    ...
                    <AcTempGraph />
                    <Divider style={{ width: "100%" }} />
                    <Box sx={{ fontSize: 20, fontWeight: "bold" }}>Acoustical Comfort</Box>
                    <NoiseGraph />
                </Stack>
            </Paper>
        </Container>
...
const DesignRecommendationSection = () => {
    ...
    return (
        <Container maxWidth="xl" disableGutters>
            <Paper elevation={2} >
                <Box width="100%" sx={{ backgroundColor: "#c09577", color: "white", borderRadius: 1, paddingX: 4, paddingY: 2 }}>
                    <Box sx={{ fontSize: 24, fontWeight: "bold" }}>Design Recommendation</Box>
                </Box>
                ...
                <FormLayout
                    leftComponent={
                        <Stack direction="column" spacing={2}>
                            <Typography>
                                • Installation of CO2 sensor, for any area with occupancy level under 2.56 person/m2
                            </Typography>
                            <Typography>
                                • Cigarette smoke control: giving separated smoking area and installation of smoking signage in any public area
                            </Typography>
                            <Typography>
                                • Management of chemical pollutants: low VOC and formaldehida for minimum of 75% ceiling, wall, floor, and furniture material-finishing, 100% non-asbestos materials.
                            </Typography>
                        </Stack>
                    }
                    rightComponent={
                        <Stack direction="column" spacing={2}>
                            ...
                            <Typography>
                                • Provide public hand-washing area.
                            </Typography>
                            <Typography>
                                • Provide signage of Mask Mandatory Area.
                            </Typography>
                            <Typography>
...
const renderActiveShape = (props) => {
    ...
    return (
        <g>
            ...
            <text x={ex + (cos >= 0 ? 1 : -1) * 12} y={ey} dy={-14} fontSize={15} fontWeight="bold" textAnchor={textAnchor} fill="#333">{`${value}`}</text>
            <text x={ex + (cos >= 0 ? 1 : -1) * 12} y={ey} dy={0} fontSize={10} textAnchor={textAnchor} fill="#333">{`kWh/m2 per year`}</text>
